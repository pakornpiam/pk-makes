...
const translations = {
  en: {
    ...
    "tutorial.box.caption": "Box Generator — full walkthrough",
    "tutorial.placeholder.text": "More guides coming",
    "tutorial.placeholder.caption": "Frame, Kumiko & Tray tutorials — coming soon",
  ...
  th: {
    ...
    "tutorial.box.caption": "Box Generator — คู่มือฉบับเต็ม",
    "tutorial.placeholder.text": "กำลังจะมีคู่มือเพิ่มเติม",
    "tutorial.placeholder.caption": "คู่มือ Frame, Kumiko และ Tray — เร็ว ๆ นี้",
